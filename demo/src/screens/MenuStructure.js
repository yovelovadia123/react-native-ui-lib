export const navigationData = {
  Foundation: {
    title: 'Foundation',
    screens: [
      {title: 'BorderRadius', tags: 'corner border radius circle', screen: 'unicorn.style.BorderRadiusesScreen'},
  ...
  Components: {
    ...
    screens: [
      ...
      {title: 'ActionBar', tags: 'action bar floating bottom', screen: 'unicorn.components.ActionBarScreen'},
      ...
      {title: 'ConnectionStatusBar', tags: 'connection status bar', screen: 'unicorn.components.ConnectionStatusBar'},
      ...
      {title: 'PageControl', tags: 'page', screen: 'unicorn.components.PageControlScreen'},
      ...
      {title: 'SharedTransition', tags: 'shared transition element', screen: 'unicorn.components.SharedTransitionScreen'},
      {title: 'StackAggregator', tags: 'stack aggregator', screen: 'unicorn.components.StackAggregatorScreen'},
  ...
  Form: {
    ...
    screens: [
      ...
      {title: 'ColorSwatch', tags: 'color swatch and palette', screen: 'unicorn.components.ColorSwatchScreen'},
      ...
      {title: 'MaskedInput', tags: 'text input form mask', screen: 'unicorn.components.MaskedInputScreen'},
      {title: 'WheelPicker', tags: 'wheel picker spinner', screen: 'unicorn.components.WheelPickerScreen'}
    ]
  },
  Overlays: {
    title: 'Overlays',
    screens: [
      {title: 'ActionSheet', tags: 'action sheet cross-platform', screen: 'unicorn.components.ActionSheetScreen'},
      {title: 'Dialog', tags: 'dialog modal popup alert', screen: 'unicorn.components.DialogScreen'},
      {title: 'FeatureHighlight', tags: 'feature overlay', screen: 'unicorn.components.FeatureHighlightScreen'},
      {title: 'FloatingButton', tags: 'floating button', screen: 'unicorn.components.FloatingButtonScreen'},
  ...
  LayoutsAndTemplates: {
    ...
    screens: [
      ...
      {title: 'withScrollEnabler', tags: 'scroll enabled withScrollEnabler', screen: 'unicorn.components.WithScrollEnablerScreen'},
      {title: 'withScrollReached', tags: 'scroll reach start end', screen: 'unicorn.components.WithScrollReachedScreen'},
      {title: 'Fader', tags: 'scroll fader', screen: 'unicorn.components.FaderScreen'},
  ...
  Native: {
    ...
    screens: [
      ...
      {title: 'Dynamic Fonts', tags: 'dynamic fonts load download', screen: 'unicorn.nativeComponents.DynamicFontsScreen'},
      {title: 'HighlighterOverlayView', tags: 'native overlay', screen: 'unicorn.nativeComponents.HighlightOverlayViewScreen'},
      {title: 'SafeAreaSpacerView', tags: 'native safe area spacer', screen: 'unicorn.nativeComponents.SafeAreaSpacerViewScreen'},
  ...
  AnimationsAndGestures: {
    ...
    screens: [
      {title: 'AnimatedImage', tags: 'animated image', screen: 'unicorn.components.AnimatedImageScreen'},
      ...
      {title: 'CardScanner', tags: 'card scanner process', screen: 'unicorn.animations.CardScannerScreen'},
      {title: 'PanDismissibleView', tags: 'pan swipe drag dismiss', screen: 'unicorn.components.PanDismissibleScreen'},
      {title: 'PanListenerView', tags: 'pan swipe drag listener', screen: 'unicorn.components.PanListenerScreen'},
      {title: 'PanResponderView', tags: 'pan swipe drag responder', screen: 'unicorn.components.PanResponderScreen'}
    ]
  },
  Incubator: {
